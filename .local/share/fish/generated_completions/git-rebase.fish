...
complete -c git-rebase -s s -l strategy -d 'Use the given merge strategy, instead of the default recursive'
...
complete -c git-rebase -l diff-algorithm -d 'diff. algorithm config setting'
